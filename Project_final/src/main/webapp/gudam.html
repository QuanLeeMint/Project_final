...
<nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto p-4 p-lg-0">
            ...
            <a href="hethongcuahang.html" class="nav-item nav-link">Hệ thống cửa hàng</a>
            <a href="cauchuyenthuonghieu.html" class="nav-item nav-link">Câu chuyện thương hiệu </a>
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown">Sản phẩm</a>
                <div class="dropdown-menu fade-up m-0">
                    <a href="cungcapcaphe.html" class="dropdown-item">Cung cấp cà phê</a>
                    <a href="nhuongquyen.html" class="dropdown-item">Nhượng quyền</a>
                    <a href="sanphambanle.html" class="dropdown-item">Sản phẩm bán lẻ</a>
                    <a href="khoahoc.html" class="dropdown-item">Đào tạo</a>
                </div>
            </div>
            <a href="contact.html" class="nav-item nav-link">Liên hệ</a>
        </div>
        <a href="login.html" class="btn btn-primary py-4 px-lg-5 d-none d-lg-block">ĐĂNG NHẬP<i class="fa fa-arrow-right ms-3"></i></a>    </div>
</nav>
<!-- Navbar End -->
